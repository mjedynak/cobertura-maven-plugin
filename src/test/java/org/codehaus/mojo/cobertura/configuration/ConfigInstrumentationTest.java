        ...
        extends TestCase
{
    ...
    public void testAdditionalExcludesConfig()
    {
        final String expectedValue = "excludes.xml;";

        configInstrumentation.setAdditionalExcludesConfig(expectedValue);

        assertEquals( expectedValue, configInstrumentation.getAdditionalExcludesConfig() );
